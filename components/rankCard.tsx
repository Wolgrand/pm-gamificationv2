...
const RankCard= ({title, position, borderColor}:CardProps):any => {
  ...
  return (
  <div className={"flex-row flex flex-initial  items-center justify-between mr-2 mt-3 w-full lg:w-5/6 px-3 py-5 lg:py-5 bg-gray-900 rounded-lg flex-shrink-0 "} style={{ borderLeft: borderColor ? `5px solid ${borderColor} ` : "0"}}>
      <div>
