...
const Nav: NextComponentType = () => {
  ...
  return (
    <nav className=" flex items-center justify-between flex-nowrap bg-gray-800 px-6 py-3 fixed w-full top-0 z-0">
      ...
      <div className="flex justify-end items-center">
          ...
          <div className="flex flex-row items-center">
            ...
            <img  className={" inlin}e-block h-12 x-14 rounded-full ring-2 ring-white"} src="https://images.unsplash.com/photo-1491528323818-fdd1faba62cc?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80" alt=""/>
            </div>
