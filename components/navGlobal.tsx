        ...
        <div className="md:flex flex-row hidden">
          {
            user?.role === 'PMO' && (
              <>
              <button  className={"mr-3 sm:mr-3  items-center px-3 py-2  rounded text-gray-500  hover:bg-gray-900 hover:text-gray-300 hover:border-gray-300" }>
              <Tooltip key={'users_tooltip_'+ String(new Date)} title={`Usuários`}>
            ...
            <button  className={"mr-3 sm:mr-3  items-center px-3 py-2  rounded text-gray-500  hover:bg-gray-900 hover:text-gray-300 hover:border-gray-300 "}>
            <Tooltip key={'achievements_tooltip_'+ String(new Date)} title={`Conquistas`}>
          ...
          <button  className={"mr-3 sm:mr-3  items-center px-3 py-2  rounded text-gray-500  hover:bg-gray-900 hover:text-gray-300 hover:border-gray-300 "}>
            <Tooltip key={'criterias_tooltip_'+ String(new Date)} title={`Entregas`}>
            ...
            <button  className={"mr-3 sm:mr-3  items-center px-3 py-2  rounded text-gray-500  hover:bg-gray-900 hover:text-gray-300 hover:border-gray-300 "}>
            <Tooltip key={'rewards_tooltip_'+ String(new Date)} title={`Recompensas`}>
            ...
            <button  className="mr-3  sm:mr-3  items-center px-3 py-2  rounded text-gray-500  hover:bg-gray-900 hover:text-gray-300 hover:border-gray-300">
          <Tooltip key={'details_tooltip_'+ String(new Date)} title={`Informações`}>
